...
const productsData = {
  "samsung-galaxy-a14": {
    ...
    price: 899,
    description:
      " O Samsung Galaxy A14 é um smartphone de nível básico da Samsung, oferecendo um desempenho decente a um preço acessível. Ele possui uma tela LCD de tamanho médio, uma configuração de câmera versátil e uma bateria de longa duração, tornando-o uma escolha sólida para usuários que buscam um dispositivo confiável para tarefas do dia a dia..",
    imageUrl: "/src/assets/galaxy-a14.png",
  },
  "iphone-15": {
    id: "iphone-15",
    name: "Iphone 15",
    ...
    imageUrl: "/src/assets/iphone15.png",
  },
  "iphone-15-pro": {
    id: "iphone-15-pro",
    name: "Iphone 15 Pro",
    ...
    imageUrl: "/src/assets/iphone15pro.png",
  },
  "samsung-galaxy-s23": {
  ...
  "redmi-note-13": {
    ...
    imageUrl: "/src/assets/note13.png",
  },
  "poco-x6-pro": {
    id: "poco-x6-pro",
    name: "POCO X6 Pro",
    ...
    imageUrl: "/src/assets/pocox6.png",
  },
};

// Exportando `productsData` como default export
